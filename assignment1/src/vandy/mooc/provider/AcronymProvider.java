...
public class AcronymProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri,
        ...
        case ACRONYMS: 
            ...
            // into the method.
            retCursor = db.query(AcronymContract.AcronymEntry.TABLE_NAME, projection, selection, selectionArgs, null, null, null);
            break;
        case ACRONYM: 
            ...
            retCursor = db.query(AcronymContract.AcronymEntry.TABLE_NAME, projection, rowId, selectionArgs, null, null, null);
            break;
        default:
            throw new UnsupportedOperationException("Unknown uri: " 
                                                    + uri);
